    ...
    <nav class="navbar background">
        <ul class="nav-list">
			...
			<a href= "adminhome.php">
				...
				<form action="active_player.php" method="POST" style="margin-left:350px">
				...
				<form action="benched_player.php" method="POST">
...
-->
        ...
        <ul class="nav-list">
  				...
  				<li><a href = "input_match.html" style="margin-left:550px">Add New Match</a></li>
				<li><a href = "update_match.php">Update Match</a></li>
				<li><a href = "delete_match.php">Delete Match</a></li>
		</ul>
