        ...
        <ul class="nav-list">
			...
			<a href= "adminhome.php">
                <img src= "logo.png" >
							...
							<li><a href = "player.php" style="margin-left:900px">Back</a></li>
...
<nav class="footer background">
    ...
    <ul class="nav-list">
		...
		<li><a href = "input_contract.html" style= "margin-left: 750px">Add New Contract</a></li>
		<li><a href = "update_contract.php">Update Contract</a></li>
	</ul>
</nav>
</body>
</html>